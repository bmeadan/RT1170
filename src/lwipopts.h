...
// extern struct netif *my_ip4_route_hook(const ip4_addr_t *src, const ip4_addr_t *dest);

#define LWIP_HOOK_IP4_ROUTE_SRC(dest, src) my_ip4_route_hook(dest, src)
